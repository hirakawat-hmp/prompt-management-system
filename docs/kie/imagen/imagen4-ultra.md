# Imagen4 Ultra API Documentation

> Generate content using the Imagen4 Ultra model

## Overview

This document describes how to use the Imagen4 Ultra model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `google/imagen4-ultra` |
...
|----------|-------|-------------|
| **Format** | `google/imagen4-ultra` | The exact model identifier for this API |
...
```json
{
  ...
  "data": {
    ...
    "model": "google/imagen4-ultra",
    "state": "waiting",
    "param": "{\"model\":\"google/imagen4-ultra\",\"input\":{\"prompt\":\"A lively comic scene where two colleagues are in an office. The first person says, 'Have you heard about Google Imagen 4 Ultra?' The second person responds with excitement, 'It’s the best text-to-image tool out there!' The first person asks again, 'Do you know where to get the API?' The second person smiles and says, 'Kie.ai has it!' In the final panel, the two look at a screen showing Kie.ai’s interface with an API option, with bright and colorful comic-style illustrations.\",\"negative_prompt\":\"Enter your prompt here...\",\"aspect_ratio\":\"1:1\",\"seed\":\"\"}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/1755155838620xiueca29.webp\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,

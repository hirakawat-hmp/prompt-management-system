# Imagen4 API Documentation

> Generate content using the Imagen4 model

## Overview

This document describes how to use the Imagen4 model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `google/imagen4` |
...
|----------|-------|-------------|
| **Format** | `google/imagen4` | The exact model identifier for this API |

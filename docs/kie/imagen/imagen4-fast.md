# Imagen4 Fast API Documentation

> Generate content using the Imagen4 Fast model

## Overview

This document describes how to use the Imagen4 Fast model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `google/imagen4-fast` |
...
|----------|-------|-------------|
| **Format** | `google/imagen4-fast` | The exact model identifier for this API |
...
```json
{
  ...
  "data": {
    ...
    "model": "google/imagen4-fast",
    "state": "waiting",
    "param": "{\"model\":\"google/imagen4-fast\",\"input\":{\"prompt\":\"Create a cinematic, photorealistic medium shot capturing the nostalgic warmth of a late 90s indie film. The focus is a young woman with brightly dyed pink hair (slightly faded) and freckled skin, looking directly and intently into the camera lens with a hopeful yet slightly uncertain smile. She wears an oversized, vintage band t-shirt (slightly worn, with the faintly cracked white text “KIE AI” across the chest) layered over a long-sleeved striped top, along with simple silver stud earrings. The lighting is soft, golden hour sunlight streaming through a slightly dusty window, creating lens flare and illuminating dust motes in the air. The background shows a blurred, cluttered bedroom with posters on the wall and fairy lights, rendered with a shallow depth of field. Natural film grain, a warm, slightly muted color palette, and sharp focus on her expressive eyes enhance the intimate, authentic feel.\",\"negative_prompt\":\"Enter your prompt here...\",\"aspect_ratio\":\"16:9\",\"num_images\":\"1\",\"seed\":42}}",
    "resultJson": "{\"resultUrls\":[\"https://file.aiquickdraw.com/custom-page/akr/section-images/17562059316812l2fpd23.webp\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
